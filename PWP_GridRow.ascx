<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PWP_GridRow.ascx.cs" Inherits="PWP_GridRow" %>
                ...
                <MasterTableView AutoGenerateColumns="False" ClientDataKeyNames="ID" DataKeyNames="ID"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn>
                            <ItemTemplate>
                                <div align="left">
                                    <asp:Label ID="lblRCurrency" runat="server" Font-Size="6px" Text='<%# Eval("Currency") %>'></asp:Label>
                                    <asp:Label ID="lblRPrice" runat="server" Font-Size="9px" Text='<%# Eval("Price") %>'></asp:Label>
                                </div>
                            </ItemTemplate>
