<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TableConfirmation.aspx.cs"
    Inherits="TableConfirmation" %>
    ...
    <div align="center">
        <asp:Panel ID="pnl" runat="server" Font-Names="Arial">
            ...
            <script language="javascript" type="text/javascript">
                ...
                function Close() {
                    if (document.getElementById('<%=hfRefresh.ClientID%>').value == "True") {
                        ...
                        <table>
                            <tr>
                                <td align="center" valign="middle">
                                    <asp:Panel ID="pnlEmployeeCode" runat="server" DefaultButton="btnConfirmTableNumber">
                                        <table>
                                            <tr>
                                                <td align="center">
                            ...
                            <tr>
                                <td align="right">
                                    <telerik:RadListView ID="lTable" runat="server" ItemPlaceholderID="EmployeesContainer"
                                        OnNeedDataSource="RadListView1_NeedDataSource" OnItemCommand="RadListView1_ItemCommand"
                                        Skin="Windows7" OnItemCreated="lTable_ItemCreated" OnPreRender="lTable_PreRender">
                                        <LayoutTemplate>
                                            <fieldset>
